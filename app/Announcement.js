...
export default function Announcement() {
  ...
  const mainColor = '#ffee00f0';     // 主要文字顏色
  const borderColor = '#fff53bed'; // 上下細線顏色 (66 代表 40% 透明度)
  const bgColor = '#ffc80038';     // 背景暈染顏色 (1a 代表 10% 透明度)

  return (
    <div 
      className="sticky top-30 z-50 max-w-[67.5vw] mx-auto mt-2 select-none backdrop-blur-md rounded-none border-y overflow-hidden shadow-lg"
      style={{ 
    ...
    >
      <div 
        className="w-full flex items-center h-5.5 text-xs font-bold tracking-wide"
