...
export default function Announcement() {
  ...
  const mainColor = '#f59e0b';     // 主要文字顏色
  const borderColor = '#f5da0b94'; // 上下細線顏色 (66 代表 40% 透明度)
  const bgColor = '#f59e0b1a';     // 背景暈染顏色 (1a 代表 10% 透明度)

  return (
    <div 
      className="sticky top-16 z-50 max-w-[80vw] mx-auto mt-2 select-none backdrop-blur-md rounded-none border-y overflow-hidden shadow-lg"
      style={{ 
